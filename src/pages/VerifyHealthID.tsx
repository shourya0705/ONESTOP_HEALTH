  ...
  return (
    <div className="max-w-4xl mx-auto px-4 py-10 font-sans space-y-8">
      ...
      <div className="text-center space-y-2">
        ...
        <h1 className="text-3xl font-extrabold text-slate-900">National Health ID Token Verifier</h1>
      ...
      <div className="bg-white p-8 rounded-3xl border border-slate-200/80 shadow-xl max-w-xl mx-auto space-y-6">
          ...
          <div className="flex gap-2">
            <div className="relative flex-1">
              ...
              <input 
                ...
                className="w-full bg-slate-50 border border-slate-200 rounded-2xl pl-10 pr-3.5 py-3 text-sm font-mono font-bold text-slate-900 focus:outline-none focus:border-teal-500"
              />
            </div>
            <button 
              type="submit"
              disabled={isScanning}
              className="bg-teal-600 hover:bg-teal-700 disabled:opacity-50 text-white font-bold px-6 py-3 rounded-2xl text-xs transition-all shadow-md flex items-center gap-2"
            >
              {isScanning ? (
                <>
      ...
      {isScanning && (
        <div className="bg-[#024959] text-teal-100 p-8 rounded-3xl border border-teal-400/30 text-center space-y-3 animate-pulse shadow-xl max-w-xl mx-auto">
      ...
      {/* ERROR DISPLAY */}
      {scanError && (
        <div className="bg-rose-50 border border-rose-200 rounded-3xl p-6 text-center space-y-2 text-rose-900 max-w-xl mx-auto shadow-md">
      ...
      {verifiedResult && !isScanning && (
        <div className="bg-white rounded-3xl border border-slate-200/80 shadow-xl p-8 max-w-xl mx-auto space-y-6 animate-fadeIn">
          
          <div className="flex items-center justify-between pb-4 border-b border-slate-100">
            <div className="flex items-center gap-3">
              <div className="w-12 h-12 rounded-2xl bg-teal-50 text-teal-600 border border-teal-100 flex items-center justify-center shadow-xs">
                <CheckCircle2 className="w-7 h-7" />
              </div>
              <div>
                <h3 className="font-extrabold text-xl text-slate-900">Identity Verified</h3>
          ...
          <div className="grid grid-cols-2 gap-4 text-xs bg-slate-50 p-4 rounded-2xl border border-slate-200/80">
            ...
            <div>
              ...
              <span className="font-mono font-bold text-teal-700">{verifiedResult.healthId}</span>
            </div>
            <div>
